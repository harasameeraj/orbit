-- ============================================================
-- SchoolConnect — Full Database Schema + RLS
...
-- One row per user. role = 'admin' | 'teacher' | 'parent'
-- ============================================================
...
-- Used in RLS policies so we don't repeat the subquery everywhere
-- ============================================================
...
-- NOTIFICATION LOG: users see their own; service role writes
...
-- ============================================================
-- SEED: create the demo school (run once)
-- After running this, copy the school UUID into your .env
-- ============================================================
