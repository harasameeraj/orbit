...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
      {/* Left: Brand panel */}
      <div style={{ background: 'linear-gradient(135deg, #1a3a6b 0%, #0f2444 60%, #122a52 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px', background: 'var(--bg)' }}>
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <p style={{ marginTop: 24, fontSize: 13, color: 'var(--text-muted)', textAlign: 'center' }}>
            St. Xavier's International Academy • SchoolConnect v1.0
          </p>
        </div>
      </div>
